...
let [num1, num2, num3, num4, num5] = numbers; //array er value golo ke venge fele onno variable er modde reke diwa
...
const studentDetails = ({firstName, roll, dob}) => { //cari braket di e destructure korse
