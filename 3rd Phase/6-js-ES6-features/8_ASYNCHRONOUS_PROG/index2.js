...
const higherOrderFunction = (y, callback) => {  //call back er modde amra ekta function ke reke di te pari and jar modde reke di thake HOF
  callback(y);
};
...
const taskOne = (callback) => {
  console.log(`Task 1`);
  callback();  //callback function ni e oi ta ke pass ko re dicchi
};
...
//   });
// });
taskOne(() => {   //1 com howar por 2 te jabe...ei rokom
  taskTwo(() => {
    taskThree(() => {
      taskFour();
    });
